...
import 'splashscreen5_model.dart';
export 'splashscreen5_model.dart';

class Splashscreen5Widget extends StatefulWidget {
  const Splashscreen5Widget({super.key});

  @override
  State<Splashscreen5Widget> createState() => _Splashscreen5WidgetState();
}

class _Splashscreen5WidgetState extends State<Splashscreen5Widget> {
  late Splashscreen5Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Splashscreen5Model());
  }
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        'We will guide you whether you are \nan individual or a group, Our \ndistinguished services encompass \nsmall and luxury events as \nper demand',
                        textAlign: TextAlign.center,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Inter',
                              color: Colors.white,
