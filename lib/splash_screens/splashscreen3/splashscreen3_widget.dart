...
import 'splashscreen3_model.dart';
export 'splashscreen3_model.dart';
          ...
          child: Stack(
            children: [
              ...
              Align(
                ...
                child: Padding(
                  padding: const EdgeInsetsDirectional.fromSTEB(56.0, 0.0, 56.0, 0.0),
                  child: Text(
              ...
              Align(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    context.pushNamed('Splashscreen4');
                  },
                  text: 'Get Started',
