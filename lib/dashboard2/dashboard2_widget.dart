...
import '/filter/pickupanddropoff/pickupanddropoff_widget.dart';
import '/filter/type/type_widget.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AllDealsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AllDealsRecord> dashboard2AllDealsRecordList = snapshot.data!;
                        ...
                        child: Column(
                          ...
                          children: [
                            Stack(
                              children: [
                                Align(
                                  alignment: const AlignmentDirectional(0.08, -0.7),
                                  child: Padding(
                                                                        ...
                                                                        .then(
                                                                          (records) =>
                                                                            ...
                                                                            records
                                                                                ...
                                                                                .toList(),
                                                                          ).search(_model.searchQuery!).map((r) => r.object).toList(),
                                                                        )
                                                                        .onError((_,
                                                                                __) =>
                            ...
                            Container(
                              ...
                              child: Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    5.0, 0.0, 5.0, 0.0),
                                child: FutureBuilder<List<AllDealsRecord>>(
                                  future: (_model.firestoreRequestCompleter ??=
                                          Completer<List<AllDealsRecord>>()
                                            ..complete(queryAllDealsRecordOnce(
                                              limit: 4,
                                            )))
                                      .future,
                                  builder: (context, snapshot) {
                                    ...
                                    return RefreshIndicator(
                                      ...
                                      child: GridView.builder(
                                        ...
                                        itemCount:
                                            gridViewAllDealsRecordList.length,
                                        itemBuilder: (context, gridViewIndex) {
                                          final gridViewAllDealsRecord =
                                              gridViewAllDealsRecordList[
                                                  gridViewIndex];
                                          return Container(
                                            width: 173.34,
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                      ...
                                      queryParameters: {
                                        'vehicleRef': serializeParam(
                                          dashboard2AllDealsRecordList.first,
                                          ParamType.Document,
                                        ),
                                      }.withoutNulls,
                                      extra: <String, dynamic>{
                            ...
                            Container(
                              ...
                              child: Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    5.0, 10.0, 5.0, 0.0),
                                child: FutureBuilder<List<AllDealsRecord>>(
                                  future: queryAllDealsRecordOnce(
                                    limit: 4,
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Align(
                                    alignment:
                                        const AlignmentDirectional(-0.01, 0.88),
                                    child: Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          20.0, 10.0, 60.0, 0.0),
                                      child: FFButtonWidget(
                        ...
                        child: Builder(
                          builder: (context) {
                            if (!_model.showSearchList) {
                              return StreamBuilder<List<AllDealsRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return ListView.builder(
                                    ...
                                    scrollDirection: Axis.vertical,
                                    itemCount:
                                        listViewAllDealsRecordList.length,
                              ...
                              return Visibility(
                                visible: _model.showSearchList,
                                child: Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 5.0, 0.0, 0.0),
                                  child: StreamBuilder<List<AllDealsRecord>>(
                                    stream: queryAllDealsRecord(
                                      queryBuilder: (allDealsRecord) =>
                                          allDealsRecord.where(
                                        'NameLowercase',
