...
import 'vehicledetails_model.dart';
export 'vehicledetails_model.dart';
            ...
            children: [
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          children: [
                            Align(
                              alignment: const AlignmentDirectional(-0.69, -0.09),
                              child: Text(
                                '2 Seater',
                            ...
                            Align(
                              alignment: const AlignmentDirectional(-0.82, -0.03),
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(0.0),
                                child: Image.asset(
                            ...
                            Align(
                              alignment: const AlignmentDirectional(0.58, -0.03),
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(0.0),
                                child: Image.asset(
              ...
              Row(
                ...
                children: [
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(19.0, 15.0, 0.0, 15.0),
                    child: Text(
                      'Choose Date',
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            fontFamily: 'Montserrat',
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          children: [
                            Align(
                              alignment: const AlignmentDirectional(-0.24, -0.61),
                              child: Text(
                                'Mon - 07 Nov',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
              ...
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(10.0, 22.0, 10.0, 22.0),
                child: Container(
                  width: 393.0,
                  height: 40.0,
                  decoration: BoxDecoration(
